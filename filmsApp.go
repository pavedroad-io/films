...
// getFilms swagger:route GET /FilmsLIST films listFilms
//
...
// getFilms swagger:route GET /Films/{uuid} films getFilms
//
...
func (a *FilmsApp) getFilms(w http.ResponseWriter, r *http.Request) {
  ...
  err := films.getFilms(a.DB, vars["key"], UUID)
...
// createFilms swagger:route POST /Films films createFilms
//
// Create a new films
//
// Responses:
...
// updateFilms swagger:route PUT /Films/{key} films updateFilms
//
...
// deleteFilms swagger:route DELETE /Films/{key} films deleteFilms
//
...
func (a *FilmsApp) deleteFilms(w http.ResponseWriter, r *http.Request) {
  ...
  err := films.deleteFilms(a.DB, vars["key"])
  if err != nil {
    respondWithError(w, http.StatusNotFound, err.Error())
    return
  }
