...
var newFilmsJSON=`{
	"filmsuuid": "56a1eeed-89b9-4216-b60e-2af1e3680c6e",
	"id": "QEgTjwkAI4ebclf",
	"title": "bzzinecUnqNJMwu",
	"updated": "2019-09-19T13:33:37-07:00",
	"created": "2019-09-19T13:33:37-07:00",
	"metadata": {
		"author": "7RpyPWcsPvFDlFR",
		"genre": "fYhKaPtjiWuGvNm",
		"rating": "z8d76gxByDe7RhI"
	}
}`
...
func clearTable() {
	a.DB.Exec("DELETE FROM acme.Films")
}
...
func addFilms(t *films) (string) {
  ...
  statement := fmt.Sprintf("INSERT INTO acme.films(films) VALUES('%s') RETURNING filmsUUID", newFilmsJSON)
